  ...
  return (
    <div className="App">
      ...
      <div id="contact">
        ...
        <p className='about-me'>I love programming and would love to work with you! Reach out to me with any of the below links! Currently seeking employment opportunities as a junior developer.</p>
